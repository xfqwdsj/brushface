...
class FaceNet128dClient(FaceNetBaseClient):
    ...
    def __init__(
        self,
        threshold: Threshold = Threshold(cosine=0.40, euclidean=10, euclidean_l2=0.80),
    ):
        self.model = load_facenet128d_model()
        self.name = "FaceNet-128d"
...
class FaceNet512dClient(FaceNetBaseClient):
    ...
    def __init__(
        ...
        threshold: Threshold = Threshold(
            cosine=0.30, euclidean=23.56, euclidean_l2=1.04
        ),
    ):
        self.model = load_facenet512d_model()
        self.name = "FaceNet-512d"
...
def inception_res_net_v2(dimension: int = 128) -> Model:
    """
